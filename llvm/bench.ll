...
define i8* @newInt(i32) {
  ...
  %class_ = call i8* @malloc(i32 28);tried 25, it worked, wtf?
  ...
  %boxedInt_ = call i8* @malloc(i32 12)
...
entry:
  %int1PP = alloca i8*
  %int2PP = alloca i8*
  %int1P = call i8* @newInt(i32 1000000)
  %int2P = call i8* @newInt(i32 0)
  store i8* %int1P, i8** %int1PP
  store i8* %int2P, i8** %int2PP
...
IF_BODY:
  ...
  %int1Sub = bitcast i8* %int1SubRaw to i8* (i8*, i8*) *
  %int1T = call i8* @newInt(i32 1)
  %int1M = call i8* %int1Sub(i8* %int1, i8* %int1T)
  store i8* %int1M, i8** %int1PP

  %int2AddRaw = call i8* @getMethodStatic(i8* %int2, i32 101)
  %int2Add = bitcast i8* %int2AddRaw to i8* (i8*, i8*) *
  %int2T = call i8* @newInt(i32 1)
  %int2M = call i8* %int2Add(i8* %int2, i8* %int2T)
  store i8* %int2M, i8** %int2PP
  br label %IF
L3:
  ret void
}
